...
export default function Navbar({onCartOpen, openAuthLogin, openAuthRegister}) {
    ...
    return (
        <header className='navbar sticky top-[0] w-full  px-6 z-50 py-[.8rem]
            ...
            <div className='flex items-center space-x-2 lg:space-x-10 p-2'>
                    ...
                    {searchOpen ? (
                        ...
                        />
                            ...
                            <IconButton
                                ...
                                onClick={handleSearchOpen} sx={{ p: 1 }}>
                ...
                <div className="flex items-center space-x-2">    
                    ...
                    <IconButton className='hover:scale-110 transition-transform' onClick={onCartOpen}>
