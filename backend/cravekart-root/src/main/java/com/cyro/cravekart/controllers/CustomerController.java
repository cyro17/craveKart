...
public class CustomerController {
  ...
  public ResponseEntity<CartResponse> incrementCartItemQuantity(@PathVariable Long cartItemId) {
  ...
  public ResponseEntity<List<OrderResponse>> getOrder() {
    ...
    List<OrderResponse> userOrders = orderService.getCustomerOrders(customerId);
