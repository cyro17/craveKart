...
public class CustomerController {
  ...
  public ResponseEntity<String> healthCheck() {
    for (USER_ROLE role : authService.getCurrentAuthUser().getRoles()) {
  ...
  public ResponseEntity<List<Order>> getOrder(){
    Long customerID = authService.getCurrentAuthUser().getId();
    List<Order> userOrders = orderService.getUserOrders(customerID);
